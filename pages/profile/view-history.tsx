...
const MyProfileViewHistory: NextPage = () => (
  <div>
    <main>
      <h1>
        I will be the view history page
      </h1>
      <div
        style={{ height: '500px' }}
      />
...
(MyProfileViewHistory as NextPageWithLayout).getLayout = function getLayout(page: ReactElement) {
  return (
    <MyProfileLayout
      tabs={tabs}
    >
