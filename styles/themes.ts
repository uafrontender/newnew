...
export const lightTheme: DefaultTheme = {
  ...
  colorsThemed: {
    ...
    appIcon: basicTheme.colors.brand1800,
    appButtonPrimary: basicTheme.colors.baseLight0,
    appButtonPrimaryBG: basicTheme.colors.baseLight50,
    appButtonSecondary: basicTheme.colors.brand1800,
    appButtonSecondaryBG: basicTheme.colors.baseLight50,
    ...
    topNavigation: basicTheme.colors.baseLight400,
    topNavigationActive: basicTheme.colors.brand1800,
    bottomNavigation: basicTheme.colors.baseLight500,
    bottomNavigationActive: basicTheme.colors.brand1800,
    mobileNavigationIcon: basicTheme.colors.baseLight500,
    mobileNavigationActiveIcon: basicTheme.colors.brand2700,
    searchInput: basicTheme.colors.baseDark900,
...
export const darkTheme: DefaultTheme = {
  ...
  colorsThemed: {
    ...
    appIcon: basicTheme.colors.baseLight0,
    appButtonPrimary: basicTheme.colors.baseLight0,
    appButtonPrimaryBG: basicTheme.colors.baseDark900,
    appButtonSecondary: basicTheme.colors.baseLight0,
    appButtonSecondaryBG: basicTheme.colors.baseDark900,
    ...
    topNavigation: basicTheme.colors.baseLight400,
    topNavigationActive: basicTheme.colors.baseLight0,
    bottomNavigation: basicTheme.colors.baseLight400,
    bottomNavigationActive: basicTheme.colors.baseLight0,
    mobileNavigationIcon: basicTheme.colors.baseLight400,
    mobileNavigationActiveIcon: basicTheme.colors.brand2700,
    searchInput: basicTheme.colors.baseLight0,
