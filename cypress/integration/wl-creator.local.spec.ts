...
context.skip('Whitelisted Creator flow', () => {
  ...
  const WL_CREATOR_EMAIL = `test_creator_wl_${testSeed}@newnew.co`;

  let creatorUsername = '';
  let firstEventShortId = '';
  let firstSuperpollShortId = '';
  let secondEventShortId = '';
  let secondSuperpollShortId = '';
  let payedToFirstSuperpoll = [];
  let payedToFirstBid = [];
  ...
  function voteOnFirstSuperpoll(
    ...
    return () => {
      if (voteOptionPrice === 'custom') {
        ...
        payedToFirstSuperpoll.push(customContribution);
      } else {
        payedToFirstSuperpoll.push(voteOptionPrice * 100);
      }
    };
  }

  function bidOnFirstEvent(
    optionText: string,
    optionAmount: number
  ): () => void {
  ...
  function voteSecondOnSuperpoll(
    ...
    return () => {
      if (voteOptionPrice === 'custom') {
        const customContribution = 2000 * 1.3 + (votesNumber - 2000) * 1;
        payedToSecondSuperpoll.push(customContribution);
      } else {
        payedToSecondSuperpoll.push(voteOptionPrice * 100);
      }
    };
  }

  function bidOnSecondEvent(
    optionText: string,
    optionAmount: number
  ): () => void {
    cy.dGet('#text-input').type(optionText);
  ...
  describe('Whitelisted creator', () => {
    ...
    it('can sign in', () => {
      ...
      cy.dGet('#authenticate-input').type(WL_CREATOR_EMAIL);
      cy.dGet('#authenticate-form').submit();
      cy.url().should('include', 'verify-email');
      cy.contains(WL_CREATOR_EMAIL);
    ...
    it('can create an event', () => {
      ...
      cy.url()
        .should('include', '/p/')
        .then((urlstring) => {
          firstEventShortId = getShortPostIdFromUrl(urlstring);
        });
    });
    ...
    it('can create a superpoll', () => {
      ...
      cy.url()
        .should('include', '/p/')
        .then((urlstring) => {
          firstSuperpollShortId = getShortPostIdFromUrl(urlstring);
        });
    });
  ...
  describe('Whitelisted user willing to contribute', () => {
    ...
    it('can contribute to a superpoll ', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll(1, 2);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('supported', 'custom', 3856);
  ...
  describe('Whitelisted user willing to become a creator', () => {
    const USER_EMAIL = WL_USER_EMAIL;
    ...
    it('can create an event', () => {
      ...
      cy.url()
        .should('include', '/p/')
        .then((urlstring) => {
          secondEventShortId = getShortPostIdFromUrl(urlstring);
        });
    });
    ...
    it('can create a superpoll', () => {
      ...
      cy.url()
        .should('include', '/p/')
        .then((urlstring) => {
          secondSuperpollShortId = getShortPostIdFromUrl(urlstring);
        });
    });
  ...
  describe('Guest willing to contribute', () => {
    ...
    it('can contribute to a superpoll', () => {
      ...
      const onSuccess = voteSecondOnSuperpoll(0, 1);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteSecondOnSuperpoll('supported', 'custom', 2100);
  ...
  describe('Guest willing to buy a bundle', () => {
    ...
    it('can contribute to a superpoll with a card payment', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('supported', 1);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('supported', 'custom', 2901);
  ...
  describe('Guest willing to add a custom option', () => {
    ...
    it('can contribute to a superpoll with a card payment', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('suggested', 1);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('suggested', 'custom', 2305);
  ...
  describe('Guest willing to buy a bundle from profile', () => {
    ...
    it('can enter post page from creators profile', () => {
      ...
      const postCardSelector = `#post-card-${secondSuperpollShortId}`;
    ...
    it('can contribute to a superpoll with a card payment', () => {
      ...
      const onSuccess = voteSecondOnSuperpoll('supported', 1);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteSecondOnSuperpoll('supported', 'custom', 13678);
  ...
  describe('User willing to contribute', () => {
    ...
    it('can contribute to an event', () => {
      ...
      const onSuccess = bidOnSecondEvent(BID_OPTION_TEXT, BID_OPTION_AMOUNT);
  ...
  describe('User willing to add card first', () => {
    ...
    it('can contribute to a superpoll', () => {
      ...
      cy.wait(5000);
      const onSuccess = voteOnFirstSuperpoll(2, 5);
    ...
    it('can make a custom contribution to a superpoll', () => {
      ...
      const onSuccess = voteOnFirstSuperpoll('supported', 'custom', 4234);
  ...
  describe('Whitelisted creator willing to respond', () => {
    const defaultStorage = {
      userTutorialsProgress:
    ...
    it('can respond to an event', () => {
      ...
      const payedToBidTotal = payedToFirstBid.reduce((acc, next) => acc + next);
      ...
      cy.dGet('#bid-details')
        .invoke('text')
        .should('contain', firstWinningBid.text);
    ...
    it('can respond to a superpoll', () => {
      ...
      const payedToSuperpollTotal = payedToFirstSuperpoll.reduce(
        (acc, next) => acc + next
      );
  ...
  describe('Whitelisted user which became creator willing to respond', () => {
    const defaultStorage = {
      userTutorialsProgress:
        '{"remainingAcSteps":[],"remainingMcSteps":[],"remainingCfSteps":[],"remainingAcCrCurrentStep":[],"remainingCfCrCurrentStep":[],"remainingMcCrCurrentStep":[], "remainingAcResponseCurrentStep":[], "remainingMcResponseCurrentStep":[]}',
    };
    ...
    it('can sign in', () => {
      ...
      cy.dGet('#authenticate-input').type(WL_USER_EMAIL);
      cy.dGet('#authenticate-form').submit();
      cy.url().should('include', 'verify-email');
      cy.contains(WL_USER_EMAIL);
    ...
    it('can respond to an event', () => {
      ...
      const payedToBidTotal = payedToSecondBid.reduce(
        (acc, next) => acc + next
      );
      cy.dGet('#total-bids-amount')
        .invoke('text')
      ...
      cy.dGet('#bid-details')
        .invoke('text')
        .should('contain', secondWinningBid.text);
    ...
    it('can respond to a superpoll', () => {
      ...
      const payedToSuperpollTotal = payedToSecondSuperpoll.reduce(
        (acc, next) => acc + next
      );
