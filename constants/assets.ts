...
const assets = {
  ...
  about: {
    media1: `${APP_ASSETS_ORIGIN}/about/media-1.png`,
    media2: `${APP_ASSETS_ORIGIN}/about/media-2.png`,
    media3: `${APP_ASSETS_ORIGIN}/about/media-3.png`,
    media4: `${APP_ASSETS_ORIGIN}/about/media-4.png`,
    media5: `${APP_ASSETS_ORIGIN}/about/media-5.png`,
    media6: `${APP_ASSETS_ORIGIN}/about/media-6.png`,
    media7: `${APP_ASSETS_ORIGIN}/about/media-7.png`,
    media8: `${APP_ASSETS_ORIGIN}/about/media-8.png`,
    media9: `${APP_ASSETS_ORIGIN}/about/media-9.png`,
  },
  openGraphImage: {
